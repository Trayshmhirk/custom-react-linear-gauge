   ...
   return (
      <>
         {drugs.map((drug, drugIndex) => (
            <div key={drugIndex} className="flex flex-col gap-8 items-start">
                  ...
                  {drug.ranges.map((range, rangeIndex) => (
                     <div key={rangeIndex} className="flex gap-3 items-center">
                        ...
                        <div className="relative">
                           <select
                              className="appearance-none w-[100px] bg-gray-100 border border-gray-300 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                  ...
                  {drug.pointers.map((pointer, pointerIndex) => (
                     ...
                     >
                        ...
                        <button
                           className="remove-btn"
                           onClick={() =>
                              removePointer(drugIndex, pointerIndex)
                           }
                        >
                           Remove
                        </button>
